...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('product_name','product_description','product_image','trending_product','product_kg','product_cost')
...
class FeedbackAdmin(admin.ModelAdmin):
    list_display=('fname','fnumber','feedback','fstatus')
    list_display_links=['fstatus']
    list_filter=['fstatus']
    search_fields = ['fname','fnumber']
